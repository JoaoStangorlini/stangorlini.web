...
const DriveIcon = () => <span className="material-symbols-outlined text-[16px] transition-colors">folder</span>;
...
export function QuickLinks() {
  const links = [
    ...
    { 
      name: 'Drive', 
      icon: <DriveIcon />, 
      href: 'https://drive.google.com/drive/folders/1qLRWEIV2Wv2FpcLEFednjsN4BS9zSBQp?usp=sharing',
